...
export default defineConfig({
  ...
  webServer: [
    {
      command: './mvnw -Dspring-boot.run.main-class=com.vokyo.backend.integration.TestBackendApplication -Dspring-boot.run.arguments=--server.port=18080 spring-boot:test-run',
